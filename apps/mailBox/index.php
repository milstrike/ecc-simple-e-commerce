...
include "../../controller/updateMailStatus.php";
include "../../view/userMailbox.php";
include "../../view/userMailboxReader.php";
?>
...
<html lang="en">
  ...
  <body>
	...
	<div class="dashboard">
                                ...
                                <dl style="color: #222;">
                                    ...
                                    <dd>
                                        <ul class="list-unstyled">
                                            ...
                                            <li style="background-color: #a6e1ec;"><a href="../mailBox/" class="btn btn-link" style="text-decoration: none;"><i class="fa fa-envelope"></i>&nbsp;Kotak Surat</a></li>
                        ...
                        <div class="col-md-9 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <table class="table table-hovered">
                                <tbody style="color: #222;">
                                    <?php echo $syndicateUserListMail;?>
                                </tbody>
                            </table>
			</div>
		</div>
      ...
      <?php echo $syndicateUserMailReader;?>
