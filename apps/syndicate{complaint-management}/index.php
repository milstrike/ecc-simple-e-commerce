...
include "../../controller/updateComplaintStatus.php";
include "../../view/syndicateAllComplaint.php";
include "../../view/syndicateComplaintReader.php";
?>
  ...
  <div class="row">
	<div class="col-sm-3">
      ...
      <ul class="nav nav-stacked">
          ...
          <li style="background-color: #a6e1ec;"><a href="../syndicate{complaint-management}/" ><i class="fa fa-group"></i> Manajemen Aduan</a></li>
      </ul>
    ...
    <div class="col-sm-9">
      ...
      <!-- column 2 -->	
      <legend><h3><i class="fa fa-group"></i> HI! Handycraft Manajemen Aduan</h3></legend>
            <div class="row">
