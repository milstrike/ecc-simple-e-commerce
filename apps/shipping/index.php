...
include "../../view/userShippingList.php";
?>
                                ...
                                <dl style="color: #222;">
                                    ...
                                    <dd>
                                        <ul class="list-unstyled">
                                            ...
                                            <li style="background-color: #a6e1ec;"><a href="../shipping/" class="btn btn-link" style="text-decoration: none;"><i class="fa fa-truck"></i>&nbsp;<i>Shipping</i></a></li>
