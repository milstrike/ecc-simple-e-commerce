...
include "../../controller/regComplaint.php";
include "../../view/syndicateUserComplaint.php";
?>
...
<html lang="en">
  ...
  <body>
	...
	<div class="dashboard">
		<div class="container">
			...
			<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                                ...
                                <dl style="color: #222;">
                                    ...
                                    <dd>
                                        <ul class="list-unstyled">
                                            ...
                                            <li style="background-color: #a6e1ec;"><a href="../complaint/" class="btn btn-link" style="text-decoration: none;"><i class="fa fa-group"></i>&nbsp;Layanan Aduan</a></li>
                                        </ul>
                                    </dd>
                                </dl>
                            </div>
                        ...
                        <div class="col-md-9 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <a href="#" class="btn btn-warning btn-sm pull-right" data-toggle="modal" data-target="#modalAduan" style="text-decoration: none;"><i class="fa fa-plus"></i> Buat Aduan</a>
                            <table class="table table-hovered">
                                ...
                                <tbody style="color: #222;">
                                    <?php echo $syndicateUserListComplaint; ?>
                                </tbody>
                            </table>
			</div>
		</div>
      ...
      <!-- Modal Login -->
<div class="modal fade" id="modalAduan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Buat Aduan</h4>
      </div>
      <div class="modal-body">
          <form role="form" action="" id="complaint" name="complaint" style="padding-bottom: 40px;" method="POST">
            <div class="form-group">
                <input type="text" class="form-control" id="subject" name="subject" placeholder="Judul Aduan" required>
            </div>
            <div class="form-group">
                <textarea class="form-control" id="content" name="content" required></textarea>
            </div>
                <button type="submit" name="submitComplaint" id="subjectComplaint" class="btn btn-info pull-right">Kirim Aduan</button>
            </form>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
