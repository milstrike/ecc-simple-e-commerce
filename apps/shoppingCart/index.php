...
include "../../controller/removeCart.php";
include "../../controller/regInvoice.php";
include "../../view/userShoppingCart.php";
			...
			<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <div class="well">
                                ...
                                <dl style="color: #222;">
                                    ...
                                    <dd>
                                        <ul class="list-unstyled">
                                            <li style="background-color: #a6e1ec;"><a href="../shoppingCart/" class="btn btn-link" style="text-decoration: none;"><i class="fa fa-shopping-cart"></i>&nbsp;Keranjang Belanja</a></li>
                        ...
                        <div class="col-md-9 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <table class="table table-hovered" width="100%">
                                ...
                                <tbody style="color: #222;">
                                    <?php echo $syndicateUserDetailShoppingCart; ?>
                                </tbody>
                                <thead style="color: #222;">
                                    <tr>
                                        ...
                                        <th style="text-align: right;">
                                            <?php echo getTotalCartByID($_SESSION["userID"], $database)?>
                                        </th>
                                        <th>
                            ...
                            <legend>Kurir dan Alamat Pengiriman</legend>
                            <?php if($rowsShoppingCart > 0){ ?>
                            <form class="form-horizontal" role="form" method="POST">
                                <input type="text" name="idUserToInvoice" id="idUserToInvoice" value="<?php echo $_SESSION["userID"]; ?>" style="visibility: hidden;"/>
                                <div class="form-group" style="color: #222;">
                                    <label for="courier" class="col-sm-4 control-label">Kurir yang tersedia untuk alamat pengiriman Anda:</label>
                                        <div class="col-sm-8">     
                                            <select name="courier" id="courier" class="form-control" class="form-control">
                                                <?php echo getOptionCourierForShipping(getActiveShippingAddressByUserID($_SESSION["userID"], $database), $database) ?>
                                            </select>
                                        </div>
                                </div>
                                <div class="form-group" style="color: #222;">
                                    <label for="" class="col-sm-4 control-label"></label>
                                        <div class="col-sm-8">     
                                            <button type="submit" name="invoiceSubmit" id="invoiceSubmit" class="btn btn-sm btn-info pull-right"><i>Check Out</i> dan lanjutkan ke pembayaran</button>
                                        </div>
                                </div>
                                <div class="form-group" style="color: #222;">
                                    <label for="" class="col-sm-4 control-label"></label>
                                        <div class="col-sm-8">     
                                            <span class="pull-right text-danger"><small>Perhatian! keranjang belanja yang telah di<i>checkout</i> tidak dapat dibatalkan kembali.</small><br/></span>
                                        </div>
                                </div>
                                <div class="form-group" style="color: #222;">
                                    <label for="" class="col-sm-4 control-label">Alamat Aktif</label>
                                        <div class="col-sm-8">     
                                            <span><?php echo getActiveAddressByUserID($_SESSION["userID"], $database);?><br/></span>
                                            <a href="../shippingAddress/" class="btn btn-warning btn-sm pull-right">Ubah Alamat Pengiriman</a>
                                        </div>
                                </div>
                                <div class="form-group" style="color: #222;">
                                    <label for="" class="col-sm-4 control-label"></label>
